            ...
            <form onSubmit={handleSubmit} className=' brightness-90 bg-createproduct max-w-sm mx-auto p-10'>
                <div className="mb-5 shadow-2-l bg-slate-300 p-4 shadow-sm">
                    <div className='text-center flex justify-center '>
                        <h1 className='font-bold text-green-500 pb-2 shadow-sm bg-slate-300 '>REGISTER PRODUCT</h1>
                    </div>
                ...
                {!response.loading && <button type="submit" className="text-white bg-green-500 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Create Product</button>}
